     ...
     <div className="ml-7 pt-5 mb-3 sm:pt-2 sm:ml-10  ">
           <Clogo/>
            ...
            <div className="flex flex-col sm:grid sm:grid-cols-2 sm:gap-2 ">
                ...
                <h1 className=" text-[#15245B] text-19px  sm:text-21px font-semibold  mt-4 ">Contactez-nous</h1>
                ...
                <p className="text-14px   sm:text-16px text-[#0D0D0D] font-normal text-center sm:ml-20 sm:pl-20 ">Copyright © 2023 SciTopia  Tous droits réservés.</p>
                </div>
            </div>
