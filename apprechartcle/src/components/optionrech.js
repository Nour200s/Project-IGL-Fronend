...
const Options = () =>{
    const[currentIndex,setcurrentIndex] = useState(0) ;
     ...
     return(
           <section>
                 <div>
                     <h1 className='flex items-center justify-center  font-signature font-extrabold text-[#15245B] mt-10 pt-10 mb-10 ml-2 sm:ml-6 text-19px md:text-26px lg:text-40px'> Outils de Recherche <br />Scientifique </h1>  
