      ...
      <div className=" mt-0 w-full p-0 h-full mb-0   grid-cols-{1} ">
        ...
        <div className=" bg-[#c3eefb]  w-full h-full  flex justify-around ">
           ...
           <div className="bg-[#c3eefb]  w-full h-full">
             <div className=" pt-10   mb-10 mr-2 sm:pl-10 ml-10 mt-10 font-extrabold  ">
              <h1 className="text-[#15245B]  text-19px sm:text-21px md:text-26px lg:text-40px">Pourquoi Choisir <br /> Notre <span className="text-[#F57581] ">site web:</span></h1>
             </div>
             <Comp/>
            </div>
             <Footer></Footer>
