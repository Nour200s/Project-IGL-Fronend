            ...
            <div className="w-full h-full bg-[#FAFAFA] font-signature font-extrabold  ml-10 mt-10 sm:ml-20 sm:mt-10  ">
                   ...
                   <h1 className=" text-[#15245B]  text-24px md:text-40px ">Bienvenue sur<br /> <span className="text-[#FBBC05]" >Sci</span> <span className="text-[#F57581] ">Topia !</span> </h1>
                    <form>
                        ...
                        <div> <input placeholder="Entrer votre nom" className=" w-4/5 rounded-md text-13px  sm:text-18px md:text-29px  ring-2 ring-[#15245B] p-2 text-[#A59E9E] font-normal   focus:outline-none" type="text" /></div>
                        <div className='mt- 2'>
                            <label className='font-semibold text-16px md:text-21px lg:30px text-[#15245B]  ' >E-mail</label>
                        </div>
                        <div> <input placeholder="Entrer votre E-mail" className="w-4/5 rounded-md text-13px  sm:text-18px md:text-29px ring-2 ring-[#15245B]  p-2 text-[#A59E9E] font-normal    focus:outline-none" type="text" /></div>
                        <div className='font-semibold text-16px md:text-21px lg:30px text-[#15245B] mt-2 '>
                            <label >Mot de passe</label>
                        </div>
                        <div><input placeholder="Entrer votre mot de passe" className=" w-4/5 rounded-md  text-13px  sm:text-18px md:text-29px  md:text-21pxmt-2 p-2   ring-2 ring-[#15245B] text-[#A59E9E] font-normal  focus:outline-none" type="password" /></div>
                        ...
                        <button className="w-4/5 my-3  bg-[#15245B] text-[#FAFAFA] font-semibold rounded-full py-3 px-8 text-14px sm:text-19px md:text-21px ">S'inscrire</button>
