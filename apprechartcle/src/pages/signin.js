    ...
    <div className="sm:flex sm:w-full   ">
           ...
           <Clogo/>
            ...
            <div className="w-full h-full bg-[#FAFAFA] font-signature font-extrabold text-24px md:text-40px ml-10 mt-10 sm:ml-20 sm:mt-20  ">
                   ...
                   <h1 className=" text-[#15245B]  text-24px md:text-40px lg:text-custom ">Bienvenue sur<br /> <span className="text-[#FBBC05]" >Sci</span> <span className="text-[#F57581] ">Topia !</span> </h1>
                    <form>
                      ...
                      <div className="flex sm:items-center sm:justify-center font-medium text-13px md:text-25px mt-3 sm:w-4/5">
