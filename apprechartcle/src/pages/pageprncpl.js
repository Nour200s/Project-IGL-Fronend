...
function Pageprncpl(){
    ...
    return (
      ...
      <div className=" w-full h-full  bg-[#c3eefb]  ">
          ...
          <div className=" flex justify-around">
            <div className="font-signature">
              ...
              <Link to="/signin">
              <button  className="  px-7 py-3 bg-[#15245B] text-[#c3eefb] text-14px md:text-19px  ml-2 mb-5 rounded-full pr-6 pl-6"> S'inscrire</button>
              </Link>
              <Link to="/login">
